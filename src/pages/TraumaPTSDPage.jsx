...
export default function TraumaPTSDPage() {
  ...
  return (
    <div ref={containerRef} className="relative bg-white overflow-hidden">
      ...
      <meta property="og:title" content="Trauma & PTSD Therapy | The Peace Practice" />
      <meta property="og:description" content="Specialized trauma and PTSD treatment with Ayana F. McKanney, LCSW, using evidence-based clinical approaches. Licensed therapy in NY, NJ & RI." />
      <meta property="og:url" content="https://www.thepeacepractice.me/specialties/trauma-ptsd" />
      ...
      <meta name="twitter:title" content="Trauma & PTSD Therapy | The Peace Practice" />
      <meta name="twitter:description" content="Specialized trauma and PTSD treatment with Ayana F. McKanney, LCSW, using evidence-based clinical approaches. Licensed therapy in NY, NJ & RI." />
