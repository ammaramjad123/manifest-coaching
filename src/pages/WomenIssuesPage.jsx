...
export default function WomenIssuesPage() {
  ...
  return (
    <div ref={containerRef} className="relative bg-white overflow-hidden">
      ...
      <meta property="og:title" content="Therapy for Women's Issues | The Peace Practice" />
      <meta property="og:description" content="Clinical therapy addressing women's mental health, motherhood, and life transitions with Ayana F. McKanney, LCSW. Licensed in NY, NJ & RI." />
      <meta property="og:url" content="https://www.thepeacepractice.me/specialties/women-issues" />
      ...
      <meta name="twitter:title" content="Therapy for Women's Issues | The Peace Practice" />
      <meta name="twitter:description" content="Clinical therapy addressing women's mental health, motherhood, and life transitions with Ayana F. McKanney, LCSW. Licensed in NY, NJ & RI." />
