...
export default function ContactPage() {
  ...
  // Routes the message to the correct inbox based on the service chosen.
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#c09050]/10 border border-[#c09050]/20 mb-6">
            ...
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#c09050]">Get in Touch</span>
          </div>
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold text-black mb-6 font-[system-ui]">
            Start Your Journey
            <span className="block bg-gradient-to-r from-[#c09050] to-[#d4a84b] bg-clip-text text-transparent mt-2 pb-2">Today</span>
          </h1>
          <p className="text-gray-500 max-w-3xl mx-auto text-base sm:text-lg lg:text-xl font-[system-ui]">
            ...
            The Peace Practice is here to support you every step of the way.
          </p>
        </div>

        {/* Banner Image */}
        <div className="relative w-full aspect-[4/3] sm:aspect-[21/7] rounded-2xl overflow-hidden mb-12 shadow-lg">
          <img
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-6 sm:p-8 md:p-10 flex flex-col">
                <div className="mb-8">
                  ...
                  <p className="text-gray-500 text-sm md:text-base font-[system-ui]">Fill out the form below and expect a response within 24 hours.</p>
                </div>
                ...
                {isSubmitted ? (
                  <div className="bg-gradient-to-r from-[#c09050]/10 to-[#d4a84b]/10 rounded-2xl p-8 text-center animate-fade-in border border-[#c09050]/20">
                    ...
                    <p className="text-gray-600 font-[system-ui]">Thank you for reaching out. You will hear back shortly.</p>
                  </div>
                ) : (
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white p-6 sm:p-8 md:p-10 border-l border-gray-200">
                <div className="mb-8">
                  <h2 className="text-2xl md:text-3xl font-bold text-black mb-2 font-[system-ui]">Connect With Us</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="font-semibold text-black font-[system-ui]">Follow The Journey</h3>
                  </div>
