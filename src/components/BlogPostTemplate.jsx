    ...
    <div className="bg-white">
      ...
      <div className="relative w-full min-h-[420px] sm:min-h-[480px] overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-5 sm:px-6 lg:px-8 pt-40 sm:pt-48 pb-10 sm:pb-14">
          ...
          >
            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/35 backdrop-blur-md border border-[#c09050]/30 text-xs font-black uppercase tracking-wider text-white mb-4 font-[system-ui]">
              {post.category}
            </span>
